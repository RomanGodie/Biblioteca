...
import com.ceiba.biblioteca.infraestructura.dto.ErrorDto;
...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        CODIGOS_ESTADO.put(ExcepcionDeNegocio.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
    }
    @ExceptionHandler(Exception.class)
    public final ResponseEntity<ErrorDto> handleAllExceptions(Exception exception) {
        ResponseEntity<ErrorDto> resultado;
        ...
        if (codigo != null) {
            ErrorDto error = new ErrorDto(mensaje);
